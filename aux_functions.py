...
def plotSolution(num_epoch,N,tt,optimizer):
    ...
    plt.legend(loc = "best")
    plt.grid()
    plt.savefig("D:/Tesis/" + optimizer +"/Solution" + str(num_epoch) + ".png",format = "png")
    plt.close()   
...
def plotError(num_epoch,vec_loss,vec_error,optimizer):
    ...
    plt.legend()
    plt.grid()
    plt.savefig("D:/Tesis/" + optimizer +"/Error" + str(num_epoch) + ".png",format = "png")
    plt.close()
...
def plotFinalSolution(tt,uu,optimizer):    
    ...
    plt.grid()
    plt.savefig("D:/Tesis/"+ optimizer + "/FinalSolution.png",format = "png")
    plt.close()
...
def plotFinalError(e,vec_loss,vec_error,optimizer):
    ...
    plt.grid()
    plt.savefig("D:/Tesis/" + optimizer + "/FinalError.png",format = "png")
    plt.close()